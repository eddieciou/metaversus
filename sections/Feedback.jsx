...
const Feedback = () => (
  <section className={`${styles.paddings} relative z-10`}>
    <motion.div
      ...
      className={`mx-auto flex flex-col lg:flex-row gap-6 ${styles.innerWidth}`}
    >
      <motion.div
      ...
      >
        ...
        <div>
          ...
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[39px] text-white">Founder | Metaversus</p>
        </div>
